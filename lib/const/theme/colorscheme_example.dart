...
import '../global_widgets/custom_gradient_appbar.dart';
import '../global_widgets/drawer/navigation_drawer.dart';
...
class _ColorSchemeExampleState extends State<ColorSchemeExample> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: CustomGradientAppBar(title: "ColorScheme",actions: [ SettingsButton(
